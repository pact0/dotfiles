...
function config.vim_dadbod_ui()
    ...
    vim.g.db_ui_save_location = require'core.global'.home ..
                                    "/.cache/vim/db_ui_queries"
    vim.g.dbs = load_dbs()
end
...
function config.markdown()
    ...
    vim.g.vim_markdown_fenced_languages = {
        "c++=javascript", "js=javascript", "json=javascript", "jsx=javascript",
        "tsx=javascript"
    }
end
...
function config.floaterm()
    ...
    vim.cmd(
        "command! NNN FloatermNew --autoclose=1 --height=0.96 --width=0.96 nnn")
    vim.cmd("command! FN FloatermNew --autoclose=1 --height=0.96 --width=0.96")
    vim.cmd(
        "command! LG FloatermNew --autoclose=1 --height=0.96 --width=0.96 lazygit")
    vim.cmd(
        "command! Ranger FloatermNew --autoclose=1 --height=0.96 --width=0.96 ranger")
...
function config.grammcheck()
    -- body
    if not packer_plugins["rhysd/vim-grammarous"] or
        not packer_plugins["rhysd/vim-grammarous"].loaded then
